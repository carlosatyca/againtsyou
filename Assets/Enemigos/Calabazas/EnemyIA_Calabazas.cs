...
public class EnemyIA_Calabazas : MonoBehaviour
{
    ...
    {
        if (!animator.GetCurrentAnimatorStateInfo(0).IsName("Calabazas_FastAttack") && !animator.GetCurrentAnimatorStateInfo(0).IsName("Calabazas_PotentialAttack"))
        {
