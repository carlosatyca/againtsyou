...
public class Acertijo5 : MonoBehaviour
{
    ...
    public void onChangeSolution()
    {
        ...
        if (temp.Length >= 8) EventSystem.current.currentSelectedGameObject.GetComponent<TMP_InputField>().text = temp[temp.Length - 1].ToString();
    }
